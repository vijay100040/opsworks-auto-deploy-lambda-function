...
module.exports = function(message, config, context) {
  ...
  async.waterfall([
      function(callback) {
        dbHandler.acquireLock(jobData.config.appName, callback);
      },
      function(callback) {
      ...
      function(callback) {
        dbHandler.releaseLock(jobData.config.appName, callback);
      }
    ],
    function(err, results) {
      if (err) {
        ...
        dbHandler.releaseLock(jobData.config.appName, utils.noopCallback);
