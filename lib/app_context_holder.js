...
exp.COMMANDS = [{
    ...
    "recipes": ["blue_green_deploy::prepare_staging"],
    "targetLayerTypes": ["app_frontend"],
    "onfailCommand": "",
    "sendCustomJson": true
  }, {
    "command": "deploy",
    ...
    "targetLayerTypes": ["app_frontend", "app_backend"],
    "onfailCommand": "__HALT_PIPELINE__",
    "sendCustomJson": false
  }

];
exp.COMMANDS_IN_PIPELINE = ['prepare_staging', 'deploy', 'test_staging', 'prepare_stg_for_prod', 'switch_to_prod', 'cleanup'];
exp.NOTIFY_STATUSES_REGEXP = ['.*failed$', '.*timedout$', 'switch_to_prod__successful$', 'cleanup__successful$'];
