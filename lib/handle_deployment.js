...
module.exports = function(message, config, context) {
  ...
  var validateDeploymentStatus = function(jobData, command, callback) {
  ...
  async.waterfall([
      ...
      function(data, callback) {
        dbHandler.updateDeploymentStatus(jobData.config.appName, utils.buildPipelineStatus(message.command, contextHolder.STATUS_INPROGRESS), data, contextHolder.STATUS_RUNNING, callback);
      },
      function(callback) {
